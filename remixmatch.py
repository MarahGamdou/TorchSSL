...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.75,
        help="param for Beta distribution of Mix Up",
    )
    ...
    parser.add_argument(
        "--ulb_loss_ratio", type=float, default=1.0, help="weight of Unsupervised Loss"
    )
    ...
    parser.add_argument(
        ...
        type=str2bool,
        default=True,
        help="Whether to use cross-entropy or Brier",
    )
