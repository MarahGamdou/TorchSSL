...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--num_eval_iter", type=int, default=5000, help="evaluation frequency"
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="none",
        help="TSA mode: none, linear, log, exp",
    )
    ...
    parser.add_argument(
        "--p_cutoff", type=float, default=0.8, help="confidencial masking threshold"
    )
